...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
   ...
   <c:forEach items="${cilist}" var="ci">
	<tr align="center">
		<td align="right">
			<a class="linkImage" href="<c:url value='BookSerlvet?method=findLoad&${ci.book.bid }'/>"><img border="0" width="54" align="top" src="<c:url value='${ci.book.image_b }'/>"/></a>
		</td>
		<td align="left">
			<a href="<c:url value='BookSerlvet?method=findLoad&${ci.book.bid }'/>"><span>${ci.book.bname }</span></a>
		</td>
		<td>&yen;${ci.book.currPrice }</td>
		<td>${ci.quantity }</td>
		<td>
			<span class="price_n">&yen;<span class="subtotal">${ci.total }</span></span>
		</td>
	</tr>
	...
	<tr>
		<td colspan="6" align="right">
			<span>总计：</span><span class="price_t">&yen;<span id="total"></span>${z_total }</span>
		</td>
	</tr>
	<tr>
